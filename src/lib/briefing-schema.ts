...
export const steps: Step[] = [
  ...
  },
  {
    ...
    fields: [
      {
        id: "prazo",
        label: "Tem alguma data ou prazo importante?",
        type: "text",
        placeholder: "Ex.: lançamento dia 15/08",
      },
      {
        id: "investimento",
      ...
      },
      {
        ...
        type: "radio",
        options: ["Sim, ambos", "Apenas domínio", "Não, preciso de orientação"],
      },
      {
        id: "observacoes",
        label: "Algo mais que gostaria de compartilhar?",
        type: "textarea",
        hint: "Ideias, restrições, expectativas...",
      },
    ],
  },
];
